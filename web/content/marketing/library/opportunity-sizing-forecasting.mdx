...
![OpenSEO keyword research for a Nashville kayak rental topic, showing search volume alongside keyword difficulty, CPC, competition, and intent](/library/keyword-research/keyword-difficulty-volume-openseo.png)
