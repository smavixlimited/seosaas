...
async function run() {
  ...
  await page.screenshot({ path: `${artifactDir}/homepage_hero_desktop.png`, fullPage: false });
  ...
  if (await featuresBtn.isVisible()) {
    ...
    await page.screenshot({ path: `${artifactDir}/navbar_dropdown_features.png` });
  }
  ...
  if (await resourcesBtn.isVisible()) {
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: `${artifactDir}/navbar_dropdown_resources.png` });
  }
  ...
  await page.goto('http://localhost:3000/confirm-email?email=growth@acmecorp.com', { waitUntil: 'domcontentloaded' });
  await page.waitForTimeout(1000);
  ...
  await page.waitForTimeout(1000);
  await page.screenshot({ path: `${artifactDir}/pricing_page.png`, fullPage: false });

  console.log('5. Blog & Docs...');
  await page.goto('http://localhost:3000/blogs', { waitUntil: 'domcontentloaded' });
  await page.waitForTimeout(1000);
  await page.screenshot({ path: `${artifactDir}/blogs_page.png`, fullPage: false });

  await page.goto('http://localhost:3000/docs', { waitUntil: 'domcontentloaded' });
  await page.waitForTimeout(1000);
  await page.screenshot({ path: `${artifactDir}/docs_page.png`, fullPage: false });

  console.log('6. Comparison page...');
  await page.goto('http://localhost:3000/vs-ahrefs-semrush', { waitUntil: 'domcontentloaded' });
  await page.waitForTimeout(1000);
  await page.screenshot({ path: `${artifactDir}/vs_ahrefs_semrush.png`, fullPage: false });
