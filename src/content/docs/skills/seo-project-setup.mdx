...
description: "Interview once and save your site's goals, positioning, competitors, and key pages to your Skorvia project context."
---
...
Your agent asks about the website, goals, positioning, competitors, and key pages once, then saves the answers to your project's context in Skorvia.
...
- Confirm the right Skorvia project and read what is already saved.
...
- Recommend the next Skorvia Agent Skill to run.
...
## Use it with Skorvia MCP

Set up [Skorvia MCP](/docs/mcp) so your agent can read and write project context and use live SEO data in later workflows. The two context tools are free.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [SEO Project Setup skill](https://github.com/every-app/skorvia/tree/main/.agents/skills/seo-project-setup)
