...
Set up [Skorvia MCP](/docs/mcp) so your agent can inspect domain overview data, ranking keywords, SERPs, and backlink context.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Competitor Analysis skill](https://github.com/every-app/skorvia/tree/main/.agents/skills/competitor-analysis)
