---
title: "Skorvia Agent Skills"
description: "Add Skorvia Agent Skills to Claude Code, Codex, or another AI agent so it can run repeatable SEO workflows with live Skorvia data."
---

Skorvia Agent Skills let you hand repeatable SEO workflows to your AI agent.
...
You stay in charge of strategy. Your agent uses Skorvia data and the skill instructions to return a recommendation, plan, or shortlist.

## Set up Skorvia Agent Skills

On Claude Code, the [Skorvia plugin](/docs/claude-code-plugin) installs MCP and every skill below in one step. On Codex CLI, the [Skorvia plugin](/docs/codex-plugin) does the same. Use the manual steps here for other agents, or if you want to pick individual skills.

1. [Set up Skorvia MCP](/docs/mcp).
2. [Set up Skorvia Agent Skills](/docs/skills/setup).

MCP connects your agent to Skorvia data. Skills tell your agent which SEO workflow to run.
...
Skorvia uses the same `SKILL.md` pattern supported by modern AI agents. To learn how skills work in your agent, read:
