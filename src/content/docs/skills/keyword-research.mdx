...
- Ask before saving keywords back to Skorvia.
...
- Confirm before saving selected keywords to Skorvia.

## Use it with Skorvia MCP

Set up [Skorvia MCP](/docs/mcp) so your agent can research live keyword metrics, inspect Google SERPs, check saved keywords, and save selected terms with your approval.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Keyword Research skill](https://github.com/every-app/skorvia/tree/main/.agents/skills/keyword-research)
