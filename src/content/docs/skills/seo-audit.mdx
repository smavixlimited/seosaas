...
Set up [Skorvia MCP](/docs/mcp) so your agent can run the audit and read backlink data, traffic estimates, and keyword ideas. The site audit is included on every plan (up to 50 pages on the free plan); the backlink, domain, and keyword lookups spend credits, and the skill keeps that spend modest.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [SEO Audit skill](https://github.com/every-app/skorvia/tree/main/.agents/skills/seo-audit)
