...
Set up [Skorvia MCP](/docs/mcp) so your agent can read saved keywords, inspect SERPs, and use Skorvia project context while clustering.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Keyword Clustering skill](https://github.com/every-app/skorvia/tree/main/.agents/skills/keyword-clustering)
