...
Connect the [Skorvia MCP](/docs/mcp) and the sizing runs against live difficulty and volume data instead of a stale export.

```text
Using the Skorvia MCP, research keywords for "[my topic]" and cluster
