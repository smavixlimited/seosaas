...
![Skorvia keyword research results with the intent column labelling each keyword informational, navigational, commercial or transactional](/library/keyword-research/intent-by-surface-openseo.png)
...
```text
Using the Skorvia MCP, research keywords for "[my topic]" and label
