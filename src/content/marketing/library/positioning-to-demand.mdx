...
![Skorvia keyword research for "fractional creative director", returning a total of nine keywords, with the term itself at 140 searches a month and the surrounding results labelled informational or navigational](/library/keyword-research/positioning-demand-validation-openseo.png)
...
```text
Using the Skorvia MCP, research "[my category term]" and these
