...
} from "@/serverFunctions/system-settings";
...
function AdminApiManagerPage() {
  ...
  const [activeCategory, setActiveCategory] =
    React.useState<ApiCategory>("seo");
  ...
  React.useEffect(() => {
    if (apiSettingsQuery.data) {
      ...
      if (apiSettingsQuery.data.analytics)
        setAnalytics(apiSettingsQuery.data.analytics);
      if (apiSettingsQuery.data.communications)
        setComms(apiSettingsQuery.data.communications);
      if (apiSettingsQuery.data.payments)
        setPayments(apiSettingsQuery.data.payments);
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: (_, variables) => {
      toast.success(
        `${variables.category.toUpperCase()} settings saved successfully!`,
      );
  ...
  const handleSaveCategory = (category: ApiCategory) => {
    ...
    if (category === "analytics")
      updateMutation.mutate({ category, analytics });
    if (category === "communications")
      updateMutation.mutate({ category, communications: comms });
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-1">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Centralized credential vault for DataForSEO, Google Search Console,
            GA4, Meta Pixel, AI LLMs, Resend, Gateways, and OAuth.
          </p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-5">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-700 pb-3">
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  Powers keyword tracking, backlink audits, and instant URL
                  push.
                </p>
              </div>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSeo({ ...seo, dataforseoLogin: e.target.value })
                  }
              ...
              <div className="space-y-1">
                ...
                <div className="relative flex items-center">
                  <input
                    ...
                    onChange={(e) =>
                      setSeo({ ...seo, dataforseoPassword: e.target.value })
                    }
                    placeholder="••••••••••••••••"
              ...
              <div className="space-y-1 md:col-span-2">
                <label className="font-semibold text-slate-700 dark:text-slate-300">
                  IndexNow Master Verification Key
                </label>
                <input
                  type="text"
                  value={seo.indexnowKey || ""}
                  onChange={(e) =>
                    setSeo({ ...seo, indexnowKey: e.target.value })
                  }
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-4">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-700 pb-3">
              ...
              <div>
                <h6 className="font-bold text-xs text-slate-800 dark:text-slate-100">
                  Firecrawl Web Crawler &amp; LLM Scraper
                </h6>
                <p className="text-[11px] text-slate-400">
                  8-in-1 AI Ingestion Studio for turning entire sites into clean
                  Markdown.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSeo({ ...seo, firecrawlApiKey: e.target.value })
                  }
                  placeholder="fc-••••••••"
                  className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
                />
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSeo({ ...seo, firecrawlApiUrl: e.target.value })
                  }
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Configure Google Search Console, Google Analytics 4, Meta
                (Facebook) Pixel, and PostHog.
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-4">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-700 pb-3">
              ...
              <div>
                <h6 className="font-bold text-xs text-slate-800 dark:text-slate-100">
                  Google Search Console (GSC) Traffic Monitor
                </h6>
                <p className="text-[11px] text-slate-400">
                  Monitor website indexing, organic search impressions, and
                  click-through rates.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
              <div className="space-y-1 md:col-span-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setAnalytics({
                      ...analytics,
                      gscSiteVerificationTag: e.target.value,
                    })
                  }
                ...
                <span className="text-[10px] text-slate-400">
                  Automatically injected into the site &lt;head&gt; for 1-click
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setAnalytics({ ...analytics, gscClientId: e.target.value })
                  }
              ...
              <div className="space-y-1 md:col-span-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setAnalytics({
                      ...analytics,
                      gscClientSecret: e.target.value,
                    })
                  }
                  placeholder="GOCSPX-••••••••"
                  className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-4">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-700 pb-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400">
                  Track user acquisition, landing page performance, and session
                  durations.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="space-y-1 md:col-span-2">
                ...
                />
                <span className="text-[10px] text-slate-400">
                  Enter your Measurement ID to activate Google tag (gtag.js)
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-4">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-700 pb-3">
              ...
              <div>
                <h6 className="font-bold text-xs text-slate-800 dark:text-slate-100">
                  Meta (Facebook) Pixel &amp; Ad Conversions
                </h6>
                <p className="text-[11px] text-slate-400">
                  Track paid ad conversions, retarget visitors, and optimize
                  Meta ad campaigns.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="space-y-1 md:col-span-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setAnalytics({ ...analytics, metaPixelId: e.target.value })
                  }
                  placeholder="123456789012345"
                  className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
                />
                <span className="text-[10px] text-slate-400">
                  Enables automated PageView and event tracking for Facebook and
                  Instagram campaigns.
                </span>
              </div>
            </div>
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-4">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-700 pb-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400">
                  Feature flags, funnels, user retention, and error recordings.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setAnalytics({
                      ...analytics,
                      posthogPublicKey: e.target.value,
                    })
                  }
                  placeholder="phc_••••••••"
                  className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
              ...
              <div className="space-y-1">
                <label className="font-semibold text-slate-700 dark:text-slate-300">
                  PostHog Host Ingestion URL
                </label>
                <input
                  type="text"
                  value={analytics.posthogHost || "https://us.i.posthog.com"}
                  onChange={(e) =>
                    setAnalytics({ ...analytics, posthogHost: e.target.value })
                  }
        ...
        <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-5">
          <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-700 pb-3">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Configure LLM providers for Skorvia AI Copilot, content
                generation, and AEO scans.
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <label className="font-bold text-slate-800 dark:text-slate-100 flex items-center gap-1.5">
                    ...
                    />
                    <span>
                      Primary Active AI Model (OpenRouter / Inference Engine)
                    </span>
                  </label>
                  <p className="text-[11px] text-slate-400">
                    Select the workhorse LLM used for SAM Copilot, Competitor
                    Strategy Decoder, and on-demand SEO fixes.
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-1">
                  ...
                  >
                    <option value="anthropic/claude-3.5-sonnet">
                      Claude 3.5 Sonnet (Recommended - Best for SEO Reasoning)
                    </option>
                    <option value="anthropic/claude-3.7-sonnet">
                      Claude 3.7 Sonnet (Latest Hybrid Reasoning)
                    </option>
                    <option value="openai/gpt-4o">
                      OpenAI GPT-4o (Omnimodel)
                    </option>
                    <option value="openai/gpt-4o-mini">
                      OpenAI GPT-4o Mini (Ultra Fast &amp; Affordable)
                    </option>
                    <option value="mistralai/mistral-large-2411">
                      Mistral Large 2411 (Mistral Flagship)
                    </option>
                    <option value="mistralai/codestral-2501">
                      Mistral Codestral 2501 (Best for Schema &amp; Code)
                    </option>
                    <option value="deepseek/deepseek-chat">
                      DeepSeek V3 (DeepSeek Chat)
                    </option>
                    <option value="minimax/minimax-m3">
                      MiniMax M3 (High Speed Reasoning)
                    </option>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) =>
                  setAi({ ...ai, anthropicApiKey: e.target.value })
                }
                placeholder="sk-ant-••••••••"
                className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
              />
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) =>
                  setAi({ ...ai, openrouterApiKey: e.target.value })
                }
        ...
        <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-5">
          <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-700 pb-3">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Powers Google Business Profile synchronization, local review
                scraping, and Geo-Grid Map Rank tracker.
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) =>
                  setLocal({ ...local, googlePlacesApiKey: e.target.value })
                }
                placeholder="AIzaSy••••••••"
                className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
              />
              <span className="text-[10px] text-slate-400">
                Used for GBP business lookup, photos, reviews &amp; citations.
              </span>
            </div>

            <div className="space-y-1">
              <label className="font-semibold text-slate-700 dark:text-slate-300">
                Google Maps JavaScript API Key (Client)
              </label>
              <input
                type="password"
                value={local.googleMapsJsApiKey || ""}
                onChange={(e) =>
                  setLocal({ ...local, googleMapsJsApiKey: e.target.value })
                }
                placeholder="AIzaSy••••••••"
                className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
              />
              <span className="text-[10px] text-slate-400">
                Used for interactive map rendering in Geo-Grid Rank Tracker.
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-5">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-700 pb-3">
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  Transactional emails, Monday SEO digests, password resets, and
                  invite dispatches.
                </p>
              </div>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setComms({ ...comms, resendApiKey: e.target.value })
                  }
                  placeholder="re_••••••••"
                  className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
                />
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setComms({ ...comms, senderEmail: e.target.value })
                  }
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setComms({ ...comms, senderName: e.target.value })
                  }
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-4">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-700 pb-3">
              ...
              <div>
                <h6 className="font-bold text-xs text-slate-800 dark:text-slate-100">
                  Loops.so Marketing &amp; Transactional CRM
                </h6>
                <p className="text-[11px] text-slate-400">
                  Automated drip campaigns, newsletter broadcasts, and user
                  lifecycle events.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setComms({ ...comms, loopsApiKey: e.target.value })
                  }
                  placeholder="••••••••••••••••"
                  className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
                />
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setComms({
                      ...comms,
                      loopsVerifyEmailTemplateId: e.target.value,
                    })
                  }
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setComms({
                      ...comms,
                      loopsResetPasswordTemplateId: e.target.value,
                    })
                  }
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Activate or deactivate individual gateways. Activated channels
                automatically appear as options in customer checkout.
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-700 pb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h6 className="font-bold text-xs text-slate-800 dark:text-slate-100">
                    Paystack (Nigeria &amp; Africa - NGN)
                  </h6>
                  <p className="text-[11px] text-slate-400">
                    Direct debit cards, USSD, Apple Pay, and automated recurring
                    billing.
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <span
                  className={`text-[11px] font-bold ${payments.paystackEnabled ? "text-emerald-600" : "text-slate-400"}`}
                >
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-700 pb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h6 className="font-bold text-xs text-slate-800 dark:text-slate-100">
                    Flutterwave (Pan-Africa &amp; Multi-Currency)
                  </h6>
                  <p className="text-[11px] text-slate-400">
                    Supports NGN, USD, KES, GHS, Mobile Money, and credit cards.
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <span
                  className={`text-[11px] font-bold ${payments.flutterwaveEnabled ? "text-emerald-600" : "text-slate-400"}`}
                >
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPayments({
                      ...payments,
                      flutterwaveEncryptionKey: e.target.value,
                    })
                  }
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-700 pb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h6 className="font-bold text-xs text-slate-800 dark:text-slate-100">
                    LemonSqueezy / Stripe (Global USD)
                  </h6>
                  <p className="text-[11px] text-slate-400">
                    Global merchant of record, automated VAT/sales tax handling,
              ...
              <div className="flex items-center gap-2">
                <span
                  className={`text-[11px] font-bold ${payments.lemonsqueezyEnabled ? "text-emerald-600" : "text-slate-400"}`}
                >
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPayments({
                      ...payments,
                      lemonsqueezyEnabled: e.target.checked,
                    })
                  }
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPayments({
                      ...payments,
                      lemonsqueezyApiKey: e.target.value,
                    })
                  }
                  placeholder="••••••••••••••••"
                  className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPayments({
                      ...payments,
                      lemonsqueezyStoreId: e.target.value,
                    })
                  }
                  placeholder="12345"
                  className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPayments({
                      ...payments,
                      lemonsqueezyWebhookSecret: e.target.value,
                    })
                  }
                  placeholder="••••••••••••••••"
                  className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-700 pb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h6 className="font-bold text-xs text-slate-800 dark:text-slate-100">
                    Direct Bank Wire &amp; Offline Transfers
                  </h6>
                  <p className="text-[11px] text-slate-400">
                    Allows customers to wire funds and upload receipts for
              ...
              <div className="flex items-center gap-2">
                <span
                  className={`text-[11px] font-bold ${payments.manualPaymentEnabled ? "text-emerald-600" : "text-slate-400"}`}
                >
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPayments({
                      ...payments,
                      manualPaymentEnabled: e.target.checked,
                    })
                  }
                />
              </div>
              ...
              <div className="sm:col-span-3 space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPayments({
                      ...payments,
                      manualPaymentInstructions: e.target.value,
                    })
                  }
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Configure 1-click Google / GitHub sign-in credentials and
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-4">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-700 pb-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400">
                  1-click "Sign in with Google" button on login and signup
                  pages.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setAuth({ ...auth, googleClientId: e.target.value })
                  }
                  placeholder="••••••••.apps.googleusercontent.com"
                  className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
                />
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setAuth({ ...auth, googleClientSecret: e.target.value })
                  }
                  placeholder="GOCSPX-••••••••"
                  className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
                />
                    ...
                    <div key={item.path} className="flex items-center justify-between gap-2 p-1.5 rounded bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          toast.success(`Copied ${item.label} URI`);
                        }}
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-4">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-700 pb-3">
              ...
              <div>
                <h6 className="font-bold text-xs text-slate-800 dark:text-slate-100">
                  Cloudflare Turnstile CAPTCHA &amp; Bot Defense
                </h6>
                <p className="text-[11px] text-slate-400">
                  Invisible, privacy-first bot mitigation for login, register,
                  and payment checkout.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setAuth({ ...auth, turnstileSiteKey: e.target.value })
                  }
              ...
              <div className="space-y-1">
                <label className="font-semibold text-slate-700 dark:text-slate-300">
                  Turnstile Secret Key (Server)
                </label>
                <input
                  type="password"
                  value={auth.turnstileSecretKey || ""}
                  onChange={(e) =>
                    setAuth({ ...auth, turnstileSecretKey: e.target.value })
                  }
                  placeholder="0x4AAAAAAA••••••••"
                  className="h-9 w-full rounded-md bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 px-3 text-xs font-mono focus:outline-none"
                />
