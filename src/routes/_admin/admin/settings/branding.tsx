...
function AdminBrandingSettingsPage() {
  ...
  const [form, setForm] = React.useState<BrandingSettings>({
    ...
    metaDescription:
      "All-in-one commercial SEO, Local Business, AI Visibility & Content SaaS.",
    metaKeywords:
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: (updated) => {
      toast.success(
        "Global site branding and registration settings saved successfully!",
      );
      setForm(updated);
    ...
    <div className="w-full space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-1">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Upload high-resolution logos, browser favicons, and configure SEO
            metadata with verified R2 persistence.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 max-w-2xl">
              ...
              . When disabled, public sign-ups are locked.
            </p>
          </div>
      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800 p-6 shadow-2xs space-y-6">
        <div className="border-b border-slate-100 dark:border-slate-700 pb-3">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Drag and drop brand assets directly. Images are uploaded to
            Cloudflare R2 bucket with fallback.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-2">
            <div>
              ...
              <span className="text-[10px] text-slate-400">
                Header logo on white/light backgrounds (PNG/SVG)
              </span>
            </div>
          ...
          <div className="space-y-2">
            <div>
              ...
              <span className="text-[10px] text-slate-400">
                Header logo on dark/navy backgrounds (PNG/SVG)
              </span>
            </div>
          ...
          <div className="space-y-2">
            <div>
              ...
              <span className="text-[10px] text-slate-400">
                Browser tab icon (32x32 / 64x64 ICO or PNG)
              </span>
            </div>
