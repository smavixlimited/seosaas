        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-5">
            ...
            <p className="text-base sm:text-lg text-base-content/70 leading-relaxed">
              Connect your Google Business Profile without tedious manual forms.
              Audit your local search presence across Apple Maps, Bing, Waze,
              and Yelp, fix citation errors, and generate 5-star customer
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-5 rounded-2xl bg-base-200/50 border border-base-300 space-y-1">
                ...
                <p className="text-xs text-base-content/60">
                  Visible across 3 of 33 directories
                </p>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-base-200/50 border border-base-300 space-y-1">
                ...
                <p className="text-xs text-base-content/60">
                  Missing on Apple Maps, Waze, Yelp
                </p>
              </div>
            ...
            <div className="rounded-2xl border border-base-300 bg-base-200/30 p-4 space-y-3">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center gap-2 p-2 rounded-xl bg-base-100 border border-base-300"
                  >
                    <Icon
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <h2 className="text-3xl font-black text-base-content">
              Built to Win Local Pack Rankings
            </h2>
            <p className="text-sm text-base-content/70">
              Stop updating directories one by one. Maintain 100% NAP
              consistency and win the top 3-pack on Google Maps.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="rounded-3xl border border-base-300 bg-base-100 p-6 space-y-3 shadow-xs">
              ...
              <h3 className="text-lg font-black text-base-content">
                1-Click Google OAuth Sync
              </h3>
              <p className="text-xs text-base-content/70 leading-relaxed">
                Connect your Google Business Profile via OAuth with zero manual
                typing. Automatically detects all branch locations managed by
                your Google account.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-base-300 bg-base-100 p-6 space-y-3 shadow-xs">
              ...
              <h3 className="text-lg font-black text-base-content">
                Review Generation QR Center
              </h3>
              <p className="text-xs text-base-content/70 leading-relaxed">
                Generate high-converting printable QR code table tents, flyers,
                and ready-to-send SMS templates that route customers directly to
                your 5-star review link.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-base-300 bg-base-100 p-6 space-y-3 shadow-xs">
              ...
              <p className="text-xs text-base-content/70 leading-relaxed">
                Respond to customer reviews with intelligent, personalized,
                SEO-friendly replies published live to Google Maps with one
                click.
              </p>
            </div>
          </div>
