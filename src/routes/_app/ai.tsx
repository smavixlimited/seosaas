...
const SUPPORT_EMAIL = "ben@skorvia.com";
      ...
      <div className="mx-auto max-w-3xl">
        ...
        {getAuthMode(import.meta.env.AUTH_MODE) === "cloudflare_access" ? (
          <div className="alert alert-warning mt-6 text-sm" role="alert">
            ...
            <span>
              ...
              <a
                href="https://skorvia.com/docs/self-hosting/cloudflare#connect-the-mcp-server-through-cloudflare-access"
                target="_blank"
                rel="noreferrer"
        ...
        <section className="mt-8">
          ...
          <p className="mt-2.5 text-xs text-base-content/55 leading-relaxed">
            Paste this into any MCP client. This URL points at the Skorvia
            instance you are using now, whether hosted, self-hosted, or local.
            Sign in with Skorvia when prompted.
          </p>
        ...
        <section className="mt-10">
          ...
          <div className="mt-4 divide-y divide-base-300 overflow-hidden rounded-lg border border-base-300 bg-base-200">
            ...
            >
              ...
              <CodeBlock
                code={`claude mcp add --transport http --scope user skorvia ${mcpUrl}`}
                onCopy={() =>
            ...
            >
              <ol className="ml-5 list-decimal space-y-1.5 text-sm text-base-content/70 leading-relaxed">
                ...
                <li>
                  Optional: after Skorvia connects, click{" "}
                  <span className="font-medium text-base-content">
                    Configure
                  </span>
                  , then choose{" "}
            ...
            >
              ...
              <CodeBlock
                code={`codex mcp add skorvia --url ${mcpUrl}`}
                onCopy={() =>
                  captureClientEvent("mcp:setup_command_copy", {
                    agent: "codex",
                  })
        ...
        <section className="mt-12">
          <h2 className="text-base font-semibold">Skorvia Skills</h2>
          <p className="mt-1.5 text-sm text-base-content/70 leading-relaxed">
            ...
            call your Skorvia MCP tools when live SERP, keyword, backlink, or
          ...
          <div className="mt-4 divide-y divide-base-300 overflow-hidden rounded-lg border border-base-300 bg-base-200">
            ...
            >
              ...
              <p className="text-sm text-base-content/70">
                You can also auto-accept each Skorvia skill:
              </p>
            ...
            {[
              {
                ...
                description:
                  "Ask questions and run research without leaving Skorvia",
              },
              {
