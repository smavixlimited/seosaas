  ...
  const featureCategories = [
    {
      ...
      description: "Everything you need to dominate Google search results and uncover competitor traffic sources.",
      items: [
        {
          name: "Keyword Research",
          benefit: "Find high-volume, low-competition buyer keywords with precise intent mapping and live SERP difficulty.",
        ...
        },
        {
          ...
          benefit: "Audit referring domains, anchor texts, toxic links, and claim competitor link gaps to build unstoppable domain authority.",
        ...
        },
        {
          ...
          benefit: "Crawl your site to detect broken links, crawlability blockers, Core Web Vitals, and on-page technical health.",
    ...
    },
    {
      ...
      description: "Next-generation capabilities to capture AI answer engines and protect paid ad conversion rates.",
      items: [
        {
          name: "Conversion & Ad Readiness (0–100)",
          benefit: "Pre-flight audit for sales pages. Catch conversion leaks, copy friction, and audit Meta & Google tracking pixels before launching ads.",
        ...
        },
        {
          ...
          benefit: "Simulate buyer prompts across ChatGPT, Perplexity, Claude, and Gemini side-by-side to see recommendations and cited sources.",
    ...
    },
    {
      ...
      description: "Tools engineered for multi-location brands, local storefronts, and digital marketing agencies.",
      items: [
        {
          name: "Local Business & GBP Sync",
          benefit: "1-Click Google OAuth detection, presence audit across 33 global directories, and in-store review generation QR kits.",
        ...
        },
        {
          ...
          benefit: "Your 24/7 in-house CMO and search strategist that analyzes your live search data and provides prioritized weekly action roadmaps.",
        ...
        },
        {
          ...
          benefit: "Generate presentation-ready, white-labeled client PDF audit reports customized with your agency logo, brand colors, and disclaimers.",
        ...
        },
        {
          ...
          benefit: "Proactive server heartbeat checks, SSL expiration tracking, and instant alerts before silent downtime damages your rankings.",
      ...
      <section className="py-16 sm:py-24 border-b border-base-300">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center space-y-4">
          ...
          <p className="text-base sm:text-lg text-base-content/70 max-w-2xl mx-auto leading-relaxed">
            Explore our comprehensive suite of modern organic growth tools built for brands, agencies, and ambitious founders.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-16">
          {featureCategories.map((cat, idx) => (
            <div key={idx} className="space-y-6">
              <div>
                <h2 className="text-2xl font-black text-base-content">{cat.category}</h2>
                <p className="text-xs sm:text-sm text-base-content/65 mt-0.5">{cat.description}</p>
              </div>
                ...
                {cat.items.map((item) => (
                  ...
                  >
                    <div className="space-y-3">
                      <div className={`h-12 w-12 rounded-2xl flex items-center justify-center ${item.color} transition-transform group-hover:scale-105`}>
                      ...
                      <h3 className="text-lg font-black text-base-content group-hover:text-primary transition-colors flex items-center justify-between">
                        <span>{item.name}</span>
                        <Icon icon="solar:arrow-right-linear" className="h-4 w-4 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
                      </h3>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <p className="text-base text-white/80 max-w-xl mx-auto leading-relaxed">
            Create your account today and experience all tools free with 500 initial credits.
          </p>
          <div>
            <Link
              to="/sign-up"
