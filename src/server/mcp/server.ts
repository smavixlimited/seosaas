  ...
  const server = new McpServer(
    {
      ...
      icons: [
        {
          src: "https://skorvia.com/android-chrome-512x512.png",
          mimeType: "image/png",
          sizes: ["512x512"],
        },
      ],
    ...
    {
      instructions:
        "Skorvia research tools use credits. Proceed with normal focused research, but ask the user for confirmation before planned batches over 2,000 credits.",
    },
  );
