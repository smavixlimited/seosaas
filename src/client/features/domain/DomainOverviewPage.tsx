...
import { CompetitorStrategyTab } from "@/client/features/domain/components/CompetitorStrategyTab";
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 px-4 py-3 border-b border-base-300">
                <div role="tablist" className="tabs tabs-border w-fit">
                  ...
                  <button
                    type="button"
                    role="tab"
                    aria-selected={routeState.tab === "strategy"}
                    className={`tab ${routeState.tab === "strategy" ? "tab-active font-bold text-primary" : ""}`}
                    onClick={() => state.handleTabChange("strategy")}
                  >
                    Strategy Decoder
                  </button>
                </div>
