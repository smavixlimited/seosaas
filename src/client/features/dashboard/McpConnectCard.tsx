...
function firstPrompts(domain: string | null): string[] {
  ...
  return [
    `Review ${site}. Ideas for what keywords we could target? Use Skorvia`,
    "Research my competitors top pages and keywords and tell me what's working. Use Skorvia",
  ];
}
        ...
        {connected ? (
          ...
          <>
            <div className="space-y-2 text-sm text-base-content/70">
              <p>
                Skorvia is designed to give your AI agent the data it needs to
