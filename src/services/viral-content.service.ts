    ...
    US: [
      {
        ...
        hookText:
          "If your organic traffic dropped 40% after Google's latest AI Overviews rollout, here is the exact 3-step entity injection fix we used to recover...",
        scriptOutline:
      ...
      },
      {
        ...
        hookText:
          "Why 80% of US tech startups are firing their $15,000/mo SEO agencies this year and doing this 10-minute automated audit instead...",
        scriptOutline:
      ...
      },
      {
        ...
        hookText:
          "Google search is NOT dying. Bad SEO is dying. Here is how we grew to 120k organic visits/mo while competitors were complaining about AI zero-clicks: 🧵👇",
        scriptOutline:
      ...
      },
      {
        ...
        hookText:
          "We analyzed the top 50 B2B SaaS websites in North America. 72% had critical technical crawl errors blocking their highest-value landing pages.",
        scriptOutline:
      ...
      },
      {
        ...
        hookText:
          "Stop spending 8 hours fixing redirect loops and broken tags. Watch this 1-click AI workflow solve it in 15 seconds flat:",
        scriptOutline:
    ...
    NG: [
      {
        ...
        hookText:
          "How Nigerian software builders and agencies are ranking on Google US & UK from Lagos with zero physical office presence...",
        scriptOutline:
        ...
        targetAudience:
          "Nigerian Tech Founders, Freelancers & Agency Operators",
        tags: [
          "#techinlagos",
          "#nigeriantitans",
          "#freelanceglobal",
      ...
      },
      {
        ...
        hookText:
          "With dollar exchange rates rising, running Meta ads to a broken landing page is burning your capital. Fix these 3 conversion leaks before spending another naira:",
        scriptOutline:
      ...
      },
      {
        ...
        viralPotentialScore: 94,
        hookText:
          "Building a global SaaS from Africa is harder than Silicon Valley, but organic search is the ultimate equalizer. Here is our exact international ranking blueprint: 🧵👇",
        scriptOutline:
        ...
        targetAudience:
          "African Tech Founders, Software Engineers & Product Managers",
    ...
    US: [
      {
        ...
        viralPotentialScore: 96,
        hookText:
          "Why DTC brands ranking in organic Google AI search are making 4x higher margins than brands burning 60% of revenue on TikTok ads...",
        scriptOutline:
        ...
        targetAudience:
          "E-commerce Founders, DTC Brand Owners & Shopify Merchants",
        tags: [
          "#shopifytips",
          "#dtcbrand",
          "#ecommercelife",
    ...
    NG: [
      {
        ...
        viralPotentialScore: 97,
        hookText:
          "Why customers in Nigeria stop DMing 'How much?' and buy instantly when your brand has high Google trust and structured reviews:",
        scriptOutline:
        ...
        targetAudience:
          "Instagram Merchants, Fashion & Beauty Brands in Nigeria",
        tags: [
          "#naijabrands",
          "#lagosvendors",
...
Generate 5 high-converting, viral content hooks tailored specifically to ${brandName}'s value proposition ("${usp}"), ${customTopic ? `focusing heavily on the custom angle "${customTopic}",` : ""} and current market trends in ${countryName}.`;
      ...
      if (Array.isArray(parsed) && parsed.length > 0) {
        generatedItems = parsed.map((it: any) => ({
          ...
          targetAudience: String(
            it.targetAudience || `Target Buyers in ${countryName}`,
          ),
      ...
      console.warn(
        "AI generation failed in ViralContentService, using dynamic country/industry heuristics:",
        aiErr,
      );
    }
    ...
    if (generatedItems.length === 0) {
      const industryHooks =
        INDUSTRY_COUNTRY_VIRAL_HOOKS[industry] ||
        INDUSTRY_COUNTRY_VIRAL_HOOKS["SaaS / Software"];
      const countryHooks =
        industryHooks[countryCode] ||
        industryHooks["US"] ||
        Object.values(industryHooks)[0];
