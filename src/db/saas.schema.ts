...
export const seoAlertConfigs = sqliteTable(
  "seo_alert_configs",
  {
    ...
    rankDropAlerts: integer("rank_drop_alerts", { mode: "boolean" }).notNull().default(true),
    criticalAuditAlerts: integer("critical_audit_alerts", { mode: "boolean" }).notNull().default(true),
    sslExpirationAlerts: integer("ssl_expiration_alerts", { mode: "boolean" }).notNull().default(true),
    uptimeDowntimeAlerts: integer("uptime_downtime_alerts", { mode: "boolean" }).notNull().default(true),
    weeklyDigestEmail: integer("weekly_digest_email", { mode: "boolean" }).notNull().default(true),
    updatedAt: text("updated_at")
      .notNull()
      .default(sql`(current_timestamp)`),
  },
...
export const cancellationSurveys = sqliteTable(
  "cancellation_surveys",
  {
    ...
    acceptedRetentionDiscount: integer("accepted_retention_discount", { mode: "boolean" })
      .notNull()
      .default(false),
...
export const userTwoFactorPending = sqliteTable(
...
export const localBusinessProfiles = sqliteTable(
  "local_business_profiles",
  {
    ...
    gbpClaimed: integer("gbp_claimed", { mode: "boolean" }).notNull().default(true),
