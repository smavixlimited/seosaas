...
CREATE INDEX `brand_audits_project_idx` ON `brand_audits` (`project_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `brand_competitors_project_idx` ON `brand_competitors` (`project_id`);--> statement-breakpoint
CREATE INDEX `brand_competitors_domain_idx` ON `brand_competitors` (`domain`);--> statement-breakpoint
...
CREATE TABLE `competitor_tracked_ads` (
	...
	`is_winning_ad` integer DEFAULT false NOT NULL,
	`is_ai_opportunity` integer DEFAULT false NOT NULL,
	`metadata_json` text DEFAULT '{}' NOT NULL,
	`created_at` text DEFAULT (current_timestamp) NOT NULL
);
--> statement-breakpoint
CREATE INDEX `competitor_ads_project_idx` ON `competitor_tracked_ads` (`project_id`);--> statement-breakpoint
CREATE INDEX `competitor_ads_competitor_domain_idx` ON `competitor_tracked_ads` (`competitor_domain`);--> statement-breakpoint
CREATE INDEX `competitor_ads_platform_idx` ON `competitor_tracked_ads` (`platform`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `trust_sentiment_project_idx` ON `trust_sentiment_audits` (`project_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `viral_content_project_idx` ON `viral_content_items` (`project_id`);--> statement-breakpoint
CREATE INDEX `viral_content_platform_idx` ON `viral_content_items` (`platform`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `waitlist_email_idx` ON `waitlist_users` (`email`);--> statement-breakpoint
CREATE INDEX `waitlist_status_idx` ON `waitlist_users` (`status`);--> statement-breakpoint
CREATE INDEX `waitlist_created_at_idx` ON `waitlist_users` (`created_at`);